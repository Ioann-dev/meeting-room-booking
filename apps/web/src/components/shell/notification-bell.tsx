    ...
    <Popover
      ...
      trigger={
        <button
          ...
          className="relative flex h-10 w-10 items-center justify-center rounded-md text-ink-muted transition-colors duration-150 ease-premium hover:bg-surface-hover hover:text-ink"
        >
          <BellIcon />
          {unreadCount > 0 && (
            <span
