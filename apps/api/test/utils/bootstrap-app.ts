...
// makes 17 such calls), and letting that throttle bleed into unrelated
// suites would make the whole run order-dependent and flaky. The real
// throttling behavior is proven separately by createThrottledTestApp below.
...
// Real ThrottlerGuard left in place, for the one spec that needs to prove
// rate limiting actually rejects requests past the configured limit.
